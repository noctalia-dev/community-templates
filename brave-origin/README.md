...
Packed Chromium theme for Brave Origin (tabs, toolbar, frame, NTP, omnibox).

Tested against Brave Origin (based on Brave) 151.1.93.136 and Noctalia v5.0.0 on Linux.
...
2. First time only — load the unpacked theme:
   ...
   3. Load unpacked → `~/.local/share/noctalia/brave-origin-theme`
...
`$XDG_DATA_HOME/noctalia/brave-origin-theme/backups/`. Restore only with Brave quit.
